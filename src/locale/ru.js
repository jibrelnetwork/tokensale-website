...
const RU = {
  ...
  confirmations: {
    withdraw: {
      fail: 'Не удалось подтвердить вывод JNT, пожалуйста попробуйте еще раз или свяжитесь с нами через поддержку',
      success: 'Ваш вывод JNT успешно подтвержден!',
      request: 'Подтверждение вывода JNT...',
    },
    changeAddress: {
      fail: 'Не удалось подтвердить смену ETH адреса, пожалуйста попробуйте еще раз или свяжитесь с нами через поддержку',
      success: 'Ваш ETH адрес успешно изменен!',
      request: 'Подтверждение смены ETH адреса...',
    },
  },
  account: {
    menu: 'Меню',
    ...
    support: 'Поддержка',
    KYCStatus: {
      label: 'Статус верификации - {{status}}',
      variants: {
        pending: 'Ожидание',
    ...
    withdraw: {
      button: 'Вывод JNT',
      confirm: {
        text: 'Вы выводите {{amount}} на ETH адрес {{address}}',
        button: 'Подтверждаю',
      },
      notApproved: {
        text: 'Ваш аккаунт еще не верифицирован. Пожалуйста дождитесь завершения процесса верификации \n или пройдите верификацию еще раз, в случае отклонения',
        button: 'Закрыть',
      },
      emptyBalance: {
        text: 'У вас на балансе нет JNT токенов для вывода.',
        button: 'Закрыть',
      },
      emptyAddress: {
        text: 'Пожалуйста укажите ETH адрес, на который вы хотите вывести JNT токены',
        button: 'Закрыть',
      },
      withdrawRequested: {
        text: 'На вашу электронную почту было отправлено письмо, пожалуйста перейдите по ссылке в письме для подтверждения вывода токенов',
        button: 'Закрыть',
      },
    },
    KYC: {
      ...
      support: 'командой поддержки',
      statuses: {
        pending: 'Вы пока еще не загрузили скан паспорта. \n Вы также можете отправить нам документы связавшись с {{support}}',
        approved: 'Ваш аккаунт был успешно верифицирован!',
        declined: 'Мы не смогли верифицировать ваш аккаунт. \n Вам было отправлено письмо с дополнительной информацией. \n Пожалуйста свяжитесь с командой поддержки для дополнительных инструкций',
        'preliminarily approved': 'Ваш аккаунт был предварительно одобрен, \n но нам необходимо провести дополнительную ручную проверку \n и это может занять некоторое время',
      },
    },
    transactions: {
