...
const RU = {
  ...
  account: {
    ...
    changePassword: {
      ...
      failure: 'Мы не смогли запросить смену пароля на сервере, пожалуйста пробуйте еще раз позже',
      request: 'Запрашиваем смену пароля на сервере...',
      success: 'На вашу электронную почту было отправлено письмо. \n Пожалуйста перейдите по ссылке в письме для подтверждения смены пароля',
      confirm: 'Если вы хотите изменить пароль - нажмите на кнопку "Изменить пароль"',
    },
  },
  verification: {
    logout: 'Выйти',
